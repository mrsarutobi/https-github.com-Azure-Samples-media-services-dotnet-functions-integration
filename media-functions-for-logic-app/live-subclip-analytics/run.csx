...
public static async Task<object> Run(HttpRequestMessage req, TraceWriter log, Microsoft.Azure.WebJobs.ExecutionContext execContext)
{
    ...
    try
    {
        ...
        */
        ...
        OutputContentModeration = AddTask(execContext, job, subclipasset, (data.contentModeration != null) ? "2.0" : null, "Azure Media Content Moderator", "ContentModeration.json", "2.0", ref taskindex, specifiedStorageAccountName: OutputStorageFromParam(data.contentModeration));
